...
var files = {
	...
	zipFileName: name + "-" + pkg.version + ".zip",

	distZipOut: path.join( dist, name + "-" + pkg.version + ".zip" ),

	imagesZipOut: path.join( dist, name + ".images-" + pkg.version + ".zip" )
};
...
files.cdn = [
	name + "-" + pkg.version + ".js",
	name + "-" + pkg.version + ".min.js",
	name + "-" + pkg.version + ".min.map",
